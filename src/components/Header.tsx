    ...
    <>
      <header className={`nav ${isScrolled ? 'solid' : ''} ${isMenuOpen ? 'menu-open' : ''}`} id="siteNav">
        ...
        <div className="nav-actions">
          ...
          {whatsappUrl && (
            <a href={whatsappUrl} className="wa-btn" target="_blank" rel="noreferrer">
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 top-[70px] bg-black z-40 flex flex-col p-6 overflow-y-auto md:hidden">
