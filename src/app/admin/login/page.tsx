    ...
    <div className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden bg-black" dir="ltr">
      ...
      <div className="w-full max-w-[420px] mx-auto p-10 sm:p-14 bg-black/50 backdrop-blur-3xl border border-gold-dim/30 shadow-[0_0_80px_rgba(212,175,55,0.08),inset_0_0_20px_rgba(212,175,55,0.02)] relative z-10 rounded-2xl group/modal">
        ...
        <div className="text-center mb-12 flex flex-col items-center">
          <Image src="/logo_dark.png" alt="Castle Crops Logo" width={80} height={80} className="mb-6 opacity-90 drop-shadow-[0_0_15px_rgba(212,175,55,0.3)] logo-dark-only" priority />
          <Image src="/logo_light.png" alt="Castle Crops Logo" width={80} height={80} className="mb-6 opacity-90 drop-shadow-[0_0_15px_rgba(212,175,55,0.3)] logo-light-only" priority />
          <span className="eyebrow mx-auto tracking-[0.4em] text-gold-bright text-xs">CASTLE CROPS</span>
          <h1 className="text-3xl font-serif-latin text-cream mt-2 mb-1 tracking-wide">Secure Portal</h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2 relative mb-2">
            <label htmlFor="password" className="text-[11px] uppercase tracking-widest text-gold-dim ml-1">Password</label>
          ...
          <div className="flex justify-end -mt-2">
            <Link href="/admin/forgot-password" className="text-xs text-gold-dim hover:text-gold transition-all hover:drop-shadow-[0_0_8px_rgba(212,175,55,0.6)]">
              Forgot Password?
            </Link>
          </div>
